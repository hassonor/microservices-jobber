...
import { IDeliveredWork, IExtendedDelivery, IOrderDocument, IOrderMessage } from '@ohjobber/shared';
...
class OrderService {
  constructor() {
    const axiosService: AxiosService = new AxiosService(`${gatewayConfig.ORDER_BASE_URL}/api/v1/order`, 'order');

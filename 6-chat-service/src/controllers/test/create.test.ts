...
import * as chatService from '@chat/services/message';
...
jest.mock('@chat/services/message');
...
describe('Chat Controller', () => {
  ...
  describe('message method', () => {
    it('should throw an error for invalid schema data', async () => {
      ...
      createMessageController(req, res).catch(() => {
        expect(helper.BadRequestError).toHaveBeenCalledWith('This is an error message', 'Create createMessage() method');
      });
    });
    ...
    it('should throw file upload error', async () => {
      ...
      createMessageController(req, res).catch(() => {
        expect(helper.BadRequestError).toHaveBeenCalledWith('File upload error. Try again', 'Create createMessage() method');
      });
    });

...
//TODO: Maybe split ratingCategories, experience and eduction to separate collection with Seller ref
const seller: Schema = new Schema(
  {
    ...
    oneliner: { type: String, default: '' }, // One line description
...
const SellerModel: Model<ISellerDocument> = model<ISellerDocument>('Seller', seller, 'Seller');
export { SellerModel };

import { IAuthPayload, IOrderDocument } from '@ohjobber/shared';
...
export const orderDocument: IOrderDocument = {
  offer: {
    ...
    description: '',
    deliveryInDays: 2,
    oldDeliveryDate: '2024-10-19T07:42:24.451Z',
    newDeliveryDate: '2024-10-20T07:42:24.451Z',
    accepted: false,
    cancelled: false,
    reason: ''
  },
  ...
  price: 20,
  requestExtension: {
    originalDate: '2024-10-19T07:42:24.451Z',
    newDate: '2024-10-20T07:42:24.451Z',
    days: 1,
    reason: 'I want to deliver a very good job',
    deliveryDateUpdate: '2024-10-20T07:42:24.451Z'
  },
  serviceFee: 0,
  requirements: '',
  approved: false,
